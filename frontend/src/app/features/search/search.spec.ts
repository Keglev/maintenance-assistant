...
describe('Search', () => {
  ...
  it('renders a sourced answer with its citations and source links', async () => {
    ...
    // The link is what makes the citation checkable rather than decorative.
    expect(
      element.querySelector('[data-testid="source-link"]')?.getAttribute('href'),
    ).toBe('/api/protocols/0f9c5b02-0000-4000-8000-000000000001/document');

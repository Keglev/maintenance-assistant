...
function initSearch() {
  ...
  request.open('GET', '/maintenance-assistant/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/maintenance-assistant/assets/css/just-the-docs-' + theme + '.css');
}
